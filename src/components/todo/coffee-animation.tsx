...
const WaterBreakAnimation = () => {
  return (
    ...
    >
      <div className="text-lg font-semibold text-foreground mb-4">Nicely done! Time to hydrate.</div>
        <div className="field">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 864.67 414.26" className="main-image">
            ...
            <g id="shadow-light" style={{ opacity: 0.5 }}>
              ...
              <path d="M183,638.94c-4.85-11.8,90.63-24.44,172.58-29,595.92-13.35,941,30.41,911.1,51.11-11.24,7.77-99.18,12.29-275.06,21.32-136.35,7-328,16.84-372.14,6.82-25.56-5.79,25.5-12.06,5.39-25.58S186.79,648.18,183,638.94Z" transform="translate(-48.24 -291.33)" style={{ fill: '#fff', opacity: 0.16 }} />
            ...
            <g id="cork-rotated" className="cork-rotated">
            ...
            <g id="bubbles-small" className="bubbles-small">
              <circle cx="186.72" cy="161.09" r="1.77" style={{ fill: 'none', stroke: '#fff', strokeMiterlimit: 10, strokeWidth: '2px', opacity: 0.62 }} />
              <circle cx="213.27" cy="128.07" r="1.77" style={{ fill: 'none', stroke: '#fff', strokeMiterlimit: 10, strokeWidth: '2px', opacity: 0.62 }} />
              <circle cx="178.5" cy="111.92" r="1.77" style={{ fill: 'none', stroke: '#fff', strokeMiterlimit: 10, strokeWidth: '2px', opacity: 0.62 }} />
              <circle cx="220.34" cy="118.49" r="1.77" style={{ fill: 'none', stroke: '#fff', strokeMiterlimit: 10, strokeWidth: '2px', opacity: 0.62 }} />
              <circle cx="206.26" cy="180.31" r="1.77" style={{ fill: 'none', stroke: '#fff', strokeMiterlimit: 10, strokeWidth: '2px', opacity: 0.62 }} />
              <circle cx="351.26" cy="216.31" r="1.77" style={{ fill: 'none', stroke: '#fff', strokeMiterlimit: 10, strokeWidth: '2px', opacity: 0.62 }} />
              <circle cx="208.03" cy="271.89" r="1.77" style={{ fill: 'none', stroke: '#fff', strokeMiterlimit: 10, strokeWidth: '2px', opacity: 0.62 }} />
              <circle cx="456.89" cy="340.31" r="1.77" style={{ fill: 'none', stroke: '#fff', strokeMiterlimit: 10, strokeWidth: '2px', opacity: 0.62 }} />
              <circle cx="490.26" cy="246.31" r="1.77" style={{ fill: 'none', stroke: '#fff', strokeMiterlimit: 10, strokeWidth: '2px', opacity: 0.62 }} />
              <circle cx="476.3" cy="219.84" r="1.77" style={{ fill: 'none', stroke: '#fff', strokeMiterlimit: 10, strokeWidth: '2px', opacity: 0.62 }} />
              <circle cx="598.77" cy="215.74" r="1.77" style={{ fill: 'none', stroke: '#fff', strokeMiterlimit: 10, strokeWidth: '2px', opacity: 0.62 }} />
              <circle cx="629.46" cy="165" r="1.77" style={{ fill: 'none', stroke: '#fff', strokeMiterlimit: 10, strokeWidth: '2px', opacity: 0.62 }} />
              <circle cx="653.44" cy="320.09" r="1.77" style={{ fill: 'none', stroke: '#fff', strokeMiterlimit: 10, strokeWidth: '2px', opacity: 0.62 }} />
              <circle cx="694.77" cy="314.37" r="1.77" style={{ fill: 'none', stroke: '#fff', strokeMiterlimit: 10, strokeWidth: '2px', opacity: 0.62 }} />
              <circle cx="769.01" cy="265.32" r="1.77" style={{ fill: 'none', stroke: '#fff', strokeMiterlimit: 10, strokeWidth: '2px', opacity: 0.62 }} />
              <circle cx="777.26" cy="229.65" r="1.77" style={{ fill: 'none', stroke: '#fff', strokeMiterlimit: 10, strokeWidth: '2px', opacity: 0.62 }} />
              <circle cx="455.12" cy="290.74" r="1.77" style={{ fill: 'none', stroke: '#fff', strokeMiterlimit: 10, strokeWidth: '2px', opacity: 0.62 }} />
              <circle cx="643.25" cy="131.61" r="1.77" style={{ fill: 'none', stroke: '#fff', strokeMiterlimit: 10, strokeWidth: '2px', opacity: 0.62 }} />
              <circle cx="362.23" cy="288.87" r="1.77" style={{ fill: 'none', stroke: '#fff', strokeMiterlimit: 10, strokeWidth: '2px', opacity: 0.62 }} />
              <circle cx="242.35" cy="306.97" r="1.77" style={{ fill: 'none', stroke: '#fff', strokeMiterlimit: 10, strokeWidth: '2px', opacity: 0.62 }} />
              <circle cx="750.06" cy="294.87" r="1.77" style={{ fill: 'none', stroke: '#fff', strokeMiterlimit: 10, strokeWidth: '2px', opacity: 0.62 }} />
              <circle cx="728.63" cy="312.6" r="1.77" style={{ fill: 'none', stroke: '#fff', strokeMiterlimit: 10, strokeWidth: '2px', opacity: 0.62 }} />
              <circle cx="337.23" cy="274.08" r="1.77" style={{ fill: 'none', stroke: '#fff', strokeMiterlimit: 10, strokeWidth: '2px', opacity: 0.62 }} />
              <circle cx="767.24" cy="287.1" r="1.77" style={{ fill: 'none', stroke: '#fff', strokeMiterlimit: 10, strokeWidth: '2px', opacity: 0.62 }} />
            </g>
          </svg>
        </div>
      <p className="text-sm text-muted-foreground mt-4">Remember to take a 5-minute water break to reset!</p>
    </motion.div>
  );
};

export default WaterBreakAnimation;
